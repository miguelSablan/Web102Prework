...
function addGamesToPage(games) {
  ...
  games.forEach((game) => {
    ...
    newDiv.innerHTML = `<img class="game-img" src="${game.img}"/> <h3>${game.name}</h3> <p>${game.description}</p> <p>Backers: ${game.backers}</p>`;
...
gamesCard.innerHTML = `<p>${totalNumberOfGames}</p>`;
...
const displayStr = `A total of $${totalAmount.toLocaleString(
  "en-us"
)} has been raised for ${
  totalNumberOfGames > 1
    ? `${totalNumberOfGames} games`
    : `${totalNumberOfGames} game`
}. Currently, ${
